...
angular.module('myApp')
    .controller('customerGM_Controller',['$rootScope','constant','$location','$scope','$filter','ExportExcel','customerGMService','$state',
        function($rootScope,constant,$location,$scope,$filter,ExportExcel,customerGMService,$state){
            //总经理
            ...
            //按4s店ID查询车辆品牌车型信息
            customerGMService.findCarInfoByStoreId().then(function(res){
            ...
            //根据4s店id查询保险公司信息
            customerGMService.findCompInfoByStoreId().then(function(res){
            ...
            //查询本店各种用户
            customerGMService.findKindsUser().then(function(res){
                if(res.status == 'OK'&&res.results.content.status=='OK'){
            ...
            //查询建档人
            customerGMService.selectUserForJdrDataSource().then(function(res){
                if(res.status == 'OK'&&res.results.content.status=='OK'){
            ...
            //查询持有人列表
            customerGMService.selectUserForHolderSearch().then(function(res){
                if(res.status == 'OK'&&res.results.content.status=='OK'){
            ...
            $scope.customerInvitedPage = {
                ...
                columnDefs: [
                    ...
                    { name: '将脱保(天)', field: 'remainLostInsurDay', width:60,enableColumnMenu: false,type:'number',headerCellTemplate: '<div class="sort_button" ng-click="grid.appScope.qjsort_yyjl(17)">将脱保(天)&nbsp;&nbsp;&nbsp;<span id="remainLostInsurDay_yyjl" class=""></span></div>'},
                    { name: '持有天数', field: 'cyts', width:60,enableColumnMenu: false,type:'number',headerCellTemplate: '<div class="sort_button" ng-click="grid.appScope.qjsort_yyjl(18)">持有天数&nbsp;&nbsp;&nbsp;<span id="cyts_yyjl" class=""></span></div>'},
            ...
            $scope.forbiddenOrRegain = function(obj){
                if(obj.userStatus != 2){
                    ...
                    $scope.makeSure = function() {
                        $("#pause").hide();
                        $("#msgwindow").show();
                        customerGMService.pauseOrForbidden(obj.userId,2).then(function(res){
                            $("#msgwindow").hide();
                            if(res.status == 'OK'){
                    ...
                    $scope.makeSure = function() {
                        $("#pause").hide();
                        $("#msgwindow").show();
                        customerGMService.pauseOrForbidden(obj.userId,0).then(function(res){
                            $("#msgwindow").hide();
                            if(res.status == 'OK'){
            ...
            $scope.pauseOrRegain = function(obj){
                ...
                if(obj.userStatus == 0){
                    ...
                    $scope.makeSure = function() {
                        $("#pause").hide();
                        customerGMService.pauseOrForbidden(obj.userId,1).then(function(res){
                            if(res.status == 'OK'){
            ...
            $scope.findInsuranceStatistics = function(pageType){
                ...
                $("#msgwindow").show();
                customerGMService.findInsuranceStatistics($scope.startTime,$scope.endTime,$scope.showAll).then(function(result){
                    $("#msgwindow").hide();
                    if (result.status == 'OK') {
            ...
            $scope.findSaleStatistics = function(pageType){
                ...
                $("#msgwindow").show();
                customerGMService.findSaleStatistics($scope.startTime,$scope.endTime,$scope.showAll).then(function(result){
                    $("#msgwindow").hide();
                    if (result.status == 'OK') {
            ...
            $scope.findServiceStatistics = function(pageType){
                ...
                $("#msgwindow").show();
                customerGMService.findServiceStatistics($scope.startTime,$scope.endTime,$scope.showAll).then(function(result){
                    $("#msgwindow").hide();
                    if (result.status == 'OK') {
            ...
            $scope.findkefu = function(pageType){
                ...
                $("#msgwindow").show();
                customerGMService.findCSCStatistics($scope.startTime,$scope.endTime,$scope.showAll).then(function(result){
                    $("#msgwindow").hide();
                    if (result.status == 'OK') {
            ...
            $scope.findIWStatistics = function(pageType){
                ...
                $("#msgwindow").show();
                customerGMService.findIWStatistics($scope.startTime,$scope.endTime,$scope.showAll).then(function(result){
                    $("#msgwindow").hide();
                    if (result.status == 'OK') {
            ...
            $scope.getSearchByTime = function (){
                ...
                if(!(re_data.test($scope.startTime)) || !(re_data.test($scope.endTime))){
                    ...
                    if($scope.pageType=='gz'){
                        ...
                        $scope.findInviteStatuGM('yyjl',$scope.pageStatus);//邀约记录
                    }else if($scope.pageType=='ht'){
            ...
            $scope.qjsort_statu = function(short){
                ...
                if($scope.pageType=='gz'){
                    ...
                    this.findInviteStatuGM('yyjl',$scope.pageStatus);//邀约记录
                }else if($scope.pageType=='ht'){
            ...
            $scope.findByTraceStatu = function(pageType,traceStatu){
                ...
                $("#msgwindow").show();
                customerGMService.findByTraceStatu($scope.condition)
            ...
            $scope.findByCusLostInsurStatu = function(pageType,cusLostInsurStatu){
                ...
                $("#msgwindow").show();
                customerGMService.findByCusLostInsurStatu($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.customerAll = result.results.content.list;
            ...
            //查询潜客邀约记录
            $scope.findInviteStatuGM = function(pageType,inviteStatu){
                $scope.rightTitleTimeToolShow();
                var short=$scope.short;
                var shortmain=$scope.shortmain;
                var renewalType = $scope.qkSearch.renewalType;
                ...
                $("#msgwindow").show();
                customerGMService.findInviteStatuGM($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
            ...
            $scope.findByAcceptStatu = function(pageType,acceptStatu){
                ...
                $("#msgwindow").show();
                customerGMService.findByAcceptStatu($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.customerAll = result.results.content.list;
            ...
            $scope.findByReturnStatu = function(pageType,returnStatu){
                ...
                $("#msgwindow").show();
                if(returnStatu==2){
                    customerGMService.findByYiHuiTui($scope.condition)
                        .then(function (result) {
                            $("#msgwindow").hide();
                            if (result.status == 'OK'&&result.results.content.status=='OK') {
                                $scope.customerAll = result.results.content.list;
                    ...
                    customerGMService.findByReturnStatu($scope.condition)
                        .then(function (result) {
                            $("#msgwindow").hide();
                            if (result.status == 'OK'&&result.results.content.status=='OK') {
                                $scope.customerAll = result.results.content.list;
            ...
            $scope.findByApprovalStatu = function(pageType,approvalStatu){
                ...
                $("#msgwindow").show();
                customerGMService.findByApprovalStatu($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.customerAll = result.results.content.list;
            ...
            $scope.findActivateCustomer = function(pageType,returnStatu){
                ...
                $("#msgwindow").show();
                customerGMService.findActivateCustomer($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
            ...
            $scope.findByJiHuo = function(pageType,pageStatus){
                ...
                $("#msgwindow").show();
                customerGMService.findByJiHuo($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.customerAll = result.results.content.list;
            ...
            $scope.findByCondition = function() {
                ...
                if($scope.startNumSearch == 1) {
                    $scope.conditionSearch = {
                        ...
                        traceEndTime: traceEndTime,zdZheKouStart:zdZheKouStart,zdZheKouEnd:zdZheKouEnd,carOwner:carOwner,
                        holder:holder,remainLostInsurDayStart:remainLostInsurDayStart,remainLostInsurDayEnd:remainLostInsurDayEnd,
                ...
                if( insuDateStartTime != null  && insuDateEndTime != null && insuDateStartTime != ""  && insuDateEndTime != "" && insuDateStartTime>insuDateEndTime){
                    ...
                    $("#msgwindow").show();
                    customerGMService.findByCondition( $scope.conditionSearch).then(function (result) {
                        $("#msgwindow").hide();
            ...
            $scope.findByCustomerId=function(customer){
                ...
                $("#msgwindow").show();
                customerGMService.findByCustomerId( $scope.customerId).then(function (result) {
                    $("#msgwindow").hide();
                    if (result.status == 'OK'&&result.results.content.status=='OK') {
                        $("#genzcl").show();
                        $("#clxhxz_gzcl").show();
            ...
            $scope.findListCustomerBJRecode = function() {
                customerGMService.findListCustomerBJRecode($scope.customerId).then(function (result) {
            ...
            $scope.findApprovalBillRecordList = function() {
                customerGMService.findApprovalBillRecordList($scope.chassisNumber).then(function (result) {
                    if (result.status == 'OK' && result.results.success == true) {
            ...
            $scope.findDdwcdCus = function(pageType,pageStatus){
                ...
                $("#msgwindow").show();
                customerGMService.findDdwcdCus($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.customerAll = result.results.content.list;
            ...
            $scope.findByConditionExport = function() {
                ...
                if( insuDateStartTime != null  && insuDateEndTime != null && insuDateStartTime != ""  && insuDateEndTime != "" && insuDateStartTime>insuDateEndTime){
                    ...
                    customerGMService.findByCondition(searchDatas).then(function (result) {
                        if (result.status == 'OK' && result.result.content.status == 'OK') {
            ...
            $scope.findByTraceStatuExport = function(pageType,traceStatu){
                ...
                customerGMService.findByTraceStatu(condition)
                    .then(function (result) {
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
            ...
            $scope.findByCusLostInsurStatuExport = function(pageType,cusLostInsurStatu){
                ...
                customerGMService.findByCusLostInsurStatu(condition)
                    .then(function (result) {
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.getExportDataCallback(result.results.content.list,result.results.content.policyCount);
                        } else {
            ...
            $scope.findByInviteStatuExport = function(pageType,inviteStatu){
                ...
                customerGMService.findByInviteStatu(condition)
                    .then(function (result) {
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.getExportDataCallback(result.results.content.list,result.results.content.policyCount);
                        } else {
            ...
            $scope.findByAcceptStatuExport = function(pageType,acceptStatu){
                ...
                var condition = {acceptStatu:acceptStatu,startNum:$scope.startNumExport, renewalType:renewalType,
                    ...
                    contactWay:contactWay,carLicenseNumber:carLicenseNumber};
                customerGMService.findByAcceptStatu(condition)
                    .then(function (result) {
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.getExportDataCallback(result.results.content.list,result.results.content.policyCount);
                        } else {
            ...
            $scope.findByReturnStatuExport = function(pageType,returnStatu){
                ...
                if(returnStatu==2){
                    customerGMService.findByYiHuiTui(condition)
                        .then(function (result) {
                            if (result.status == 'OK'&&result.results.content.status=='OK') {
                                $scope.getExportDataCallback(result.results.content.list,result.results.content.policyCount);
                            } else {
                    ...
                    customerGMService.findByReturnStatu(condition)
                        .then(function (result) {
                            if (result.status == 'OK'&&result.results.content.status=='OK') {
                                $scope.getExportDataCallback(result.results.content.list,result.results.content.policyCount);
                            } else {
            ...
            $scope.findByApprovalStatuExport = function(pageType,approvalStatu){
                ...
                customerGMService.findByApprovalStatu(condition)
                    .then(function (result) {
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.getExportDataCallback(result.results.content.list,result.results.content.policyCount);
                        } else {
            ...
            $scope.findActivateCustomerExport = function(pageType,returnStatu){
                ...
                customerGMService.findActivateCustomer(condition)
                    .then(function (result) {
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
            ...
            $scope.findByJiHuoExport = function(pageType,pageStatus){
                ...
                customerGMService.findByJiHuo(condition).then(function (result) {
                    if (result.status == 'OK'&&result.results.content.status=='OK') {
                        $scope.getExportDataCallback(result.results.content.list,result.results.content.policyCount);
                    } else {
            ...
            $scope.findDdwcdCusExport = function(pageType,pageStatus){
                ...
                customerGMService.findDdwcdCus(condition).then(function (result) {
                    if (result.status == 'OK'&&result.results.content.status=='OK') {
                        $scope.getExportDataCallback(result.results.content.list,result.results.content.policyCount);
                    } else {
            ...
            $scope.getExportGzjlData = function () {
                if ($scope.pageType == 'gz') {
                    ...
                    if($scope.pageStatus == 5){
                        $scope.findByReturnStatuGzjlExport('ht', $scope.pageStatus)//回退
                    }else{
                        $scope.findByReturnCustomerStatuGzjlExport('ht', $scope.pageStatus)//回退
                    }
            ...
            $scope.findByConditionGzjlExport = function() {
                ...
                if( insuDateStartTime != null  && insuDateEndTime != null && insuDateStartTime != ""  && insuDateEndTime != "" && insuDateStartTime>insuDateEndTime){
                    ...
                    customerGMService.findByConditionGzjl(searchDatas).then(function (result) {
                        if (result.status == 'OK' && result.results.content.status == 'OK') {
            ...
            $scope.findByTraceStatuGzjlExport = function(pageType,traceStatu){
                ...
                customerGMService.findByTraceStatuGzjl(condition)
                    .then(function (result) {
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            if($scope.gzjlBol==true){
                                $scope.getExportGzjlDataCallback(result.results.content.listGzjl,result.results.content.customerCount,
            ...
            $scope.findByCusLostInsurStatuGzjlExport = function(pageType,cusLostInsurStatu){
                ...
                customerGMService.findByCusLostInsurStatuGzjl(condition)
                    .then(function (result) {
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            if($scope.gzjlBol==true){
                                $scope.getExportGzjlDataCallback(result.results.content.listGzjl,result.results.content.customerCount,
            ...
            $scope.findByInviteStatuGzjlExport = function(pageType,inviteStatu){
                ...
                customerGMService.findInviteStatuGM(condition).then(function (result) {
                    if (result.status == 'OK'&&result.results.content.status=='OK') {
            ...
            $scope.findByAcceptStatuGzjlExport = function(pageType,acceptStatu){
                ...
                customerGMService.findByAcceptStatuGzjl(condition)
                    .then(function (result) {
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            if($scope.gzjlBol==true){
                                $scope.getExportGzjlDataCallback(result.results.content.listGzjl,result.results.content.customerCount,
            ...
            $scope.findByReturnStatuGzjlExport = function(pageType,returnStatu){
                ...
                customerGMService.findByReturnStatuGzjl(condition)
                    .then(function (result) {
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            if($scope.gzjlBol==true){
                                $scope.getExportGzjlDataCallback(result.results.content.listGzjl,result.results.content.customerCount,
            ...
            //根据回退状态查询---导出潜客跟踪记录
            $scope.findByReturnCustomerStatuGzjlExport = function(pageType,returnStatu){
                $scope.loadFinish = false;
                var renewalType = $scope.qkSearch.renewalType;
                var holder = $scope.qkSearch.holder;
                var contact = $scope.qkSearch.contact;
            ...
            $scope.findByApprovalStatuGzjlExport = function(pageType,approvalStatu){
                ...
                customerGMService.findByApprovalStatuGzjl(condition)
                    .then(function (result) {
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            if($scope.gzjlBol==true){
                                $scope.getExportGzjlDataCallback(result.results.content.listGzjl,result.results.content.customerCount,
            ...
            $scope.findActivateCustomerGzjlExport = function(pageType,returnStatu){
                ...
                customerGMService.findActivateCustomerGzjl(condition)
                    .then(function (result) {
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            if($scope.gzjlBol==true){
                                $scope.getExportGzjlDataCallback(result.results.content.listGzjl,result.results.content.customerCount,
            ...
            $scope.findwxRecordByCondition = function(){
                ...
                customerGMService.findwxRecordByCondition($scope.condition)
                    .then(function (result) {
            ...
            $scope.maintainDetails=function(maintainNumber){
                ...
                $("#msgwindow").show();
                customerGMService.findByMaintainNumber($scope.maintainNumber).then(function (result) {
                    $("#msgwindow").hide();
                    if (result.status == 'OK'&&result.results.content.status=='OK') {
            ...
            $scope.findByConditionTSX = function(){
                ...
                customerGMService.findByConditionTSX($scope.condition)
                    .then(function (result) {
            ...
            $scope.pushDetails=function(reportNumber){
                ...
                $("#msgwindow").show();
                customerGMService.findPMaintenanceByRNumber($scope.reportNumber).then(function (result) {
                    $("#msgwindow").hide();
                    if (result.status == 'OK'&&result.results.content.status=='OK') {
                        $("#pushDetailAll").show();
