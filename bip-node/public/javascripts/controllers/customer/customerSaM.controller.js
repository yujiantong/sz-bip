...
angular.module('myApp')
    .controller('customerSaM_Controller',['$rootScope','$scope','$filter','customerSaMService','$state','checkService',
        function($rootScope,$scope,$filter,customerSaMService,$state,checkService){
            //  销售经理
            ...
            //按4s店ID查询车辆品牌车型信息
            customerSaMService.findCarInfoByStoreId().then(function(res){
            ...
            //根据4s店id查询保险公司信息
            customerSaMService.findCompInfoByStoreId().then(function(res){
            ...
            //查询本店各种用户
            customerSaMService.findKindsUser().then(function(res){
                if(res.status == 'OK'&&res.results.content.status=='OK'){
            ...
            //查询持有人列表
            customerSaMService.selectUserForHolderSearch().then(function(res){
                if(res.status == 'OK'&&res.results.content.status=='OK'){
            ...
            $scope.customerAllSearchPage = {
                ...
                columnDefs: [
                    ...
                    { name: '联系方式', field: 'contactWay',minWidth:65,enableColumnMenu: false,cellTooltip: true,headerCellTemplate: '<div class="sort_button" ng-click="grid.appScope.qjsort(5)">联系方式&nbsp;&nbsp;&nbsp;<span id="contactWay" class=""></span></div>'},
            ...
            $scope.forbiddenOrRegain = function(obj,roleId){
                if(obj.userStatus != 2){
                    ...
                    $scope.makeSure = function() {
                        $("#pause").hide();
                        $("#msgwindow").show();
                        customerSaMService.pauseOrForbidden(obj.userId,2,roleId).then(function(res){
                            $("#msgwindow").hide();
                            if(res.status == 'OK'){
                    ...
                    $scope.makeSure = function() {
                        $("#pause").hide();
                        $("#msgwindow").show();
                        customerSaMService.pauseOrForbidden(obj.userId,0).then(function(res){
                            $("#msgwindow").hide();
                            if(res.status == 'OK'){
            ...
            $scope.pauseOrRegain = function(obj){
                ...
                if(obj.userStatus == 0){
                    ...
                    $scope.makeSure = function() {
                        $("#pause").hide();
                        customerSaMService.pauseOrForbidden(obj.userId,1).then(function(res){
                            if(res.status == 'OK'){
            ...
            $scope.findSaleStatistics = function(pageType){
                ...
                $("#msgwindow").show();
                customerSaMService.findSaleStatistics($scope.startTime,$scope.endTime,$scope.showAll).then(function(result){
                    $("#msgwindow").hide();
                    if (result.status == 'OK') {
            ...
            $scope.findByTraceStatu = function(pageType,traceStatu){
                ...
                $("#msgwindow").show();
                customerSaMService.findByTraceStatu($scope.condition)
            ...
            $scope.findByCusLostInsurStatu = function(pageType,cusLostInsurStatu){
                ...
                $("#msgwindow").show();
                customerSaMService.findByCusLostInsurStatu($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.customerAll = result.results.content.list;
            ...
            $scope.findByAcceptStatu = function(pageType,acceptStatu){
                ...
                $("#msgwindow").show();
                customerSaMService.findByAcceptStatu($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.customerAll = result.results.content.list;
            ...
            $scope.findByReturnStatu = function(pageType,returnStatu){
                ...
                $("#msgwindow").show();
                if(returnStatu=='3,7'){
                    customerSaMService.findByApproval($scope.condition)
                        .then(function (result) {
                            $("#msgwindow").hide();
                            if (result.status == 'OK'&&result.results.content.status=='OK') {
                                $scope.customerAll = result.results.content.list;
                    ...
                    customerSaMService.findByYiHuiTui($scope.condition)
                        .then(function (result) {
                            $("#msgwindow").hide();
                            if (result.status == 'OK'&&result.results.content.status=='OK') {
                                $scope.customerAll = result.results.content.list;
                    ...
                    customerSaMService.findByReturnStatu($scope.condition)
                        .then(function (result) {
                            $("#msgwindow").hide();
                            if (result.status == 'OK'&&result.results.content.status=='OK') {
                                $scope.customerAll = result.results.content.list;
            ...
            $scope.findDdwcdCus = function(pageType,pageStatus){
                ...
                $("#msgwindow").show();
                customerSaMService.findDdwcdCus($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.customerAll = result.results.content.list;
            ...
            $scope.findByCondition = function(){
                ...
                if($scope.startNumSearch == 1) {
                    $scope.conditionSearch = {
                        ...
                        condition: {
                            ...
                            holder:holder,sfgyx:sfgyx,ifLoan:ifLoan
                        }
                    }
                }else{
                ...
                if( insurDateLYStart != null  && insurDateLYEnd != null && insurDateLYStart != ""  && insurDateLYEnd != "" && insurDateLYStart>insurDateLYEnd){
                    ...
                    $("#msgwindow").show();
                    customerSaMService.findByCondition($scope.conditionSearch)
                        .then(function (result) {
                            $("#msgwindow").hide();
                            if (result.status == 'OK' && result.results.content.status == 'OK') {
                                $("#msgwindow").hide();
            ...
            $scope.findByCustomerId=function(customer){
                ...
                $("#msgwindow").show();
                customerSaMService.findByCustomerId( $scope.customerId).then(function (result) {
                    $("#msgwindow").hide();
                    if (result.status == 'OK'&&result.results.content.status=='OK') {
                        $("#genzcl").show();
                        $("#clxhxz_gzcl").show();
                ...
                customerSaMService.findAllSubordinate(customer.clerkId).then(function (result) {
                    if (result.status == 'OK'&& result.results.content.status=='OK') {
            ...
            $scope.findListCustomerBJRecode = function() {
                customerSaMService.findListCustomerBJRecode($scope.customerId).then(function (result) {
            ...
            $scope.findApprovalBillRecordList = function() {
                customerSaMService.findApprovalBillRecordList($scope.chassisNumber).then(function (result) {
                    if (result.status == 'OK' && result.results.success == true) {
            ...
            $scope.traceReturn = function(){
                ...
                $scope.makesure = function() {
                    ...
                    $("#tyht").hide();
                    $("#msgwindow").show();
                    customerSaMService.traceReturn($scope.customerId,$scope.clerkId,$scope.confirmData.tyhtyj,
            ...
            $scope.traceReturnZD = function(){
                ...
                $scope.makesure = function() {
                    ...
                    $("#zdht").hide();
                    $("#msgwindow").show();
                    customerSaMService.returnByXSJLZD($scope.customerId,$scope.clerkId,$scope.confirmData.zdhtyj,
                        $scope.principalId,$scope.principal)
                        .then(function (result) {
                            $("#msgwindow").hide();
                            if (result.status == 'OK'&& result.results.content.status=='OK') {
            ...
            //销售经理更换负责人
            $scope.replacePrincipalSaM = function(){
                ...
                $scope.makesure = function() {
                    ...
                    $("#ghfzr").hide();
                    $("#msgwindow").show();
                    customerSaMService.replacePrincipalSaM($scope.newPrincipal.principal.id,
            ...
            //不同意回退
            $scope.unAgreeReturnBySCM = function(){
                $("#jjht").show();
                $scope.makesure = function() {
                    ...
                    $("#jjht").hide();
                    $("#msgwindow").show();
                    customerSaMService.unAgreeReturnBySCM($scope.customerId, $scope.clerkId,$scope.principalId,$scope.principal,$scope.confirmData.jjhtyy)
                        .then(function (result) {
                            $("#msgwindow").hide();
                            if (result.status == 'OK' && result.results.content.status == 'OK') {
                                $("#genzcl").hide();
            ...
            $scope.replacePriBox = function() {
                $("#plghfzr").show();
                customerSaMService.findSubordinate().then(function (result) {
                    if (result.status == 'OK'&&result.results.content.status=='OK') {
            ...
            $scope.replacePri = function() {
                ...
                if(SelectedCount == 0){
                    ...
                    $("#msgwindow").show();
                    customerSaMService.changePrincipalBatch($scope.ReplaceDatas).then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $("#plghfzr").hide();
                            if($scope.pageType=='qkcx'){
            ...
            $scope.findwxRecordByCondition = function(){
                ...
                customerSaMService.findwxRecordByCondition($scope.condition)
                    .then(function (result) {
            ...
            $scope.maintainDetails=function(maintainNumber){
                ...
                $("#msgwindow").show();
                customerSaMService.findByMaintainNumber($scope.maintainNumber).then(function (result) {
                    $("#msgwindow").hide();
                    if (result.status == 'OK'&&result.results.content.status=='OK') {
            ...
            $scope.findByConditionTSX = function(){
                ...
                customerSaMService.findByConditionTSX($scope.condition)
                    .then(function (result) {
            ...
            $scope.pushDetails=function(reportNumber){
                ...
                $("#msgwindow").show();
                customerSaMService.findPMaintenanceByRNumber($scope.reportNumber).then(function (result) {
                    $("#msgwindow").hide();
                    if (result.status == 'OK'&&result.results.content.status=='OK') {
                        $("#pushDetailAll").show();
