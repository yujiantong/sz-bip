...
angular.module('myApp')
    .controller('customerSC_Controller',['$rootScope','$scope','$filter','customerSCService','$timeout','$interval','$state','checkService',
        function($rootScope,$scope,$filter,customerSCService,$timeout,$interval,$state,checkService){
            //销售顾问
            //页面状态，用于判断页面的类型
            ...
            //按4s店ID查询车辆品牌车型信息
            customerSCService.findCarInfoByStoreId().then(function(res){
            ...
            //根据4s店id查询保险公司信息
            customerSCService.findCompInfoByStoreId().then(function(res){
            ...
            //查询本店各种用户
            customerSCService.findKindsUser().then(function(res){
                if(res.status == 'OK'&&res.results.content.status=='OK'){
            ...
            $scope.saleStatisticsAllPage = {
                ...
                columnDefs: [
                    ...
                    { name: '新保出单', field: 'newBillCount',enableColumnMenu: false},
                    { name: '新转续出单', field: 'newToContinueBillCount',enableColumnMenu: false}
                ],
            ...
            $scope.findSCSaleStatistics = function(pageType){
                $scope.rightTitleTimeToolShow();
                $scope.pageType = pageType;
                $scope.saleStatisticsAllPage.data = [];
                $("#msgwindow").show();
                customerSCService.findSCSaleStatistics($scope.startTime,$scope.endTime,$scope.showAll).then(function(result){
                    $("#msgwindow").hide();
                    if (result.status == 'OK') {
            ...
            $scope.customerNoReceivedPage = {
                ...
                columnDefs: [
                    ...
                    { name: '客户级别',enableColumnMenu: false,width:70,cellClass:'text-center',cellTemplate: '<div role="button">' +
                    '<span ng-class="{starbg:row.entity.sfgyx==1}" class="nostarbg">{{row.entity.customerLevel}}</span></div>',headerCellTemplate: '<div class="sort_button" ng-click="grid.appScope.qjsort_wjs(11)">客户级别&nbsp;&nbsp;&nbsp;<span id="customerLevel_wjs" class=""></span></div>'},
            ...
            $scope.addColumns = function() {
                ...
                '<div role="button" title="{{row.entity.bhUpdateTime}}" class="ui-grid-cell-contents"><span class="glyphicon glyphicon-exclamation-sign red"  ng-if="row.entity.showNum>1000*60*60*24*row.entity.dayNumber"></span>' +
                '<span class="glyphicon glyphicon-exclamation-sign blue"  ng-if="0<row.entity.showNum&&row.entity.showNum<=1000*60*60*24*row.entity.dayNumber"></span>'+
                '<span>{{row.entity.bhInsuranceEndDate}}</span></div>',headerCellTemplate: '<div class="sort_button" ng-click="grid.appScope.qjsort_statu(10)">更新日期&nbsp;&nbsp;&nbsp;<span id="bhInsuranceEndDate" class=""></span></div>'});
            }
            ...
            $scope.getSearchByTime = function (){
                ...
                if(!(re_data.test($scope.startTime)) || !(re_data.test($scope.endTime))){
                    ...
                    if($scope.pageType=='gz'){
                        ...
                        $scope.findSCSaleStatistics('xstj');
            ...
            $scope.qjsort_statu = function(short){
                ...
                if(shortmain%2==0){
                    $scope.shortmain=2;
                    if(short==2){
                        $("#principal_statu").attr("class","sort_desc")
                        $("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                        ...
                        $("#clerk_statu").attr("class","sort_desc")
                        $("#principal_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","")
                    }else if(short==4){
                        $("#contact_statu").attr("class","sort_desc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","")
                    }else if(short==5){
                        $("#contactWay_statu").attr("class","sort_desc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#chassisNumber_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","")
                    }else if(short==6){
                        $("#chassisNumber_statu").attr("class","sort_desc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class",""); $("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","")
                    }else if(short==7){
                        $("#carLicenseNumber_statu").attr("class","sort_desc")
                        ...
                        $("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","")
                    }else if(short==8){
                        $("#coverTypeName_statu").attr("class","sort_desc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class",""); $("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","")
                    }else if(short==9){
                        $("#jqxrqEnd_statu").attr("class","sort_desc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","")
                    }else if(short==10){
                        $("#bhInsuranceEndDate_statu").attr("class","sort_desc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","")
                    }else if(short==11){
                        $("#customerLevel_statu").attr("class","sort_desc");
                        $("#gotThroughNum_statu").attr("class",""),$("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");
                        $("#chassisNumber_statu").attr("class","");$("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        ...
                        $("#gotThroughNum_statu").attr("class","sort_desc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                    }else if(short==13){
                        $("#willingTraceDate_statu").attr("class","sort_desc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        ...
                        $("#lastTraceDate_statu").attr("class","sort_desc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        ...
                        $("#lastTraceResult_statu").attr("class","sort_desc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        ...
                        $("#delayDate_statu").attr("class","sort_desc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        ...
                        $("#remainLostInsurDay_statu").attr("class","sort_desc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#cyts_statu").attr("class","");$("#holder_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                    }else if(short==18){
                        $("#cyts_statu").attr("class","sort_asc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#holder_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                    }else if(short==19){
                        $("#holder_statu").attr("class","sort_desc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                    }
                }
                else{
                    $scope.shortmain=1;
                    if(short==2){
                        $("#principal_statu").attr("class","sort_asc")
                        $("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","")
                    }else if(short==3){
                        $("#clerk_statu").attr("class","sort_asc")
                        $("#principal_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","")
                    }else if(short==4){
                        $("#contact_statu").attr("class","sort_asc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","")
                    }else if(short==5){
                        $("#contactWay_statu").attr("class","sort_asc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#chassisNumber_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","")
                    }else if(short==6){
                        $("#chassisNumber_statu").attr("class","sort_asc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class",""); $("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","")
                    }else if(short==7){
                        $("#carLicenseNumber_statu").attr("class","sort_asc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","")
                    }else if(short==8){
                        $("#coverTypeName_statu").attr("class","sort_asc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class",""); $("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","")
                    }else if(short==9){
                        $("#jqxrqEnd_statu").attr("class","sort_asc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","")
                    }else if(short==10){
                        $("#bhInsuranceEndDate_statu").attr("class","sort_asc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","")
                    }else if(short==11){
                        $("#customerLevel_statu").attr("class","sort_asc");
                        $("#gotThroughNum_statu").attr("class",""),$("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");
                        $("#chassisNumber_statu").attr("class","");$("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","")
                    }else if(short==12){
                        $("#gotThroughNum_statu").attr("class","sort_asc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                    }else if(short==13){
                        $("#willingTraceDate_statu").attr("class","sort_asc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                    }else if(short==14){
                        $("#lastTraceDate_statu").attr("class","sort_asc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                    }else if(short==15){
                        $("#lastTraceResult_statu").attr("class","sort_asc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                    }else if(short==16){
                        $("#delayDate_statu").attr("class","sort_asc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#holder_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                    }else if(short==17){
                        $("#remainLostInsurDay_statu").attr("class","sort_asc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#cyts_statu").attr("class","");$("#holder_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                    }else if(short==18){
                        $("#cyts_statu").attr("class","sort_desc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#holder_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                    }else if(short==19){
                        $("#holder_statu").attr("class","sort_asc")
                        $("#principal_statu").attr("class","");$("#clerk_statu").attr("class","");$("#contact_statu").attr("class","");$("#contactWay_statu").attr("class","");$("#chassisNumber_statu").attr("class","");
                        $("#carLicenseNumber_statu").attr("class","");$("#coverTypeName_statu").attr("class","");$("#jqxrqEnd_statu").attr("class","");$("#bhInsuranceEndDate_statu").attr("class","");
                        $("#willingTraceDate_statu").attr("class","");$("#gotThroughNum_statu").attr("class","");$("#lastTraceDate_statu").attr("class","");$("#lastTraceResult_statu").attr("class","");$("#delayDate_statu").attr("class","");
                        $("#remainLostInsurDay_statu").attr("class","");$("#cyts_statu").attr("class","");$("#customerLevel_statu").attr("class","");
                ...
                if($scope.pageType=='gz'){
                    ...
                    this.findSCSaleStatistics('xstj');
                }else if($scope.pageType=='ddwcd'){
            ...
            $scope.findByTraceStatu = function(pageType,traceStatu){
                ...
                $("#msgwindow").show();
                customerSCService.findByTraceStatu($scope.condition)
            ...
            $scope.findByCusLostInsurStatu = function(pageType,cusLostInsurStatu){
                ...
                $("#msgwindow").show();
                customerSCService.findByCusLostInsurStatu($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.customerAll = result.results.content.list;
            ...
            $scope.qjsort_wjs = function(short){
                ...
                if(shortmain%2==0){
                    $scope.shortmain=2;
                    if(short==2){
                        $("#principal_wjs").attr("class","sort_desc")
                        $("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                        ...
                        $("#clerk_wjs").attr("class","sort_desc")
                        $("#principal_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","")
                    }else if(short==4){
                        $("#contact_wjs").attr("class","sort_desc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","")
                    }else if(short==5){
                        $("#contactWay_wjs").attr("class","sort_desc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","")
                    }else if(short==6){
                        $("#chassisNumber_wjs").attr("class","sort_desc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class",""); $("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","")
                    }else if(short==7){
                        $("#carLicenseNumber_wjs").attr("class","sort_desc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","")
                    }else if(short==8){
                        $("#coverTypeName_wjs").attr("class","sort_desc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class",""); $("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","")
                    }else if(short==9){
                        $("#jqxrqEnd_wjs").attr("class","sort_desc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","")
                    }else if(short==10){
                        $("#bhInsuranceEndDate_wjs").attr("class","sort_desc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","")
                    }else if(short==11){
                        $("#customerLevel_wjs").attr("class","sort_desc");
                        $("#gotThroughNum_wjs").attr("class",""),$("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");
                        $("#chassisNumber_wjs").attr("class","");$("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","")
                    }else if(short==12){
                        $("#gotThroughNum_wjs").attr("class","sort_desc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                    }else if(short==13){
                        $("#willingTraceDate_wjs").attr("class","sort_desc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                    }else if(short==14){
                        $("#lastTraceDate_wjs").attr("class","sort_desc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                    }else if(short==15){
                        $("#lastTraceResult_wjs").attr("class","sort_desc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                    }else if(short==16){
                        $("#delayDate_wjs").attr("class","sort_desc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                    }else if(short==17){
                        $("#remainLostInsurDay_wjs").attr("class","sort_desc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                    }else if(short==18){
                        $("#cyts_wjs").attr("class","sort_asc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#holder_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                    }else if(short==19){
                        $("#holder_wjs").attr("class","sort_desc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                    }
                }
                else{
                    $scope.shortmain=1;
                    if(short==2){
                        $("#principal_wjs").attr("class","sort_asc")
                        $("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","")
                    }else if(short==3){
                        $("#clerk_wjs").attr("class","sort_asc")
                        $("#principal_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","")
                    }else if(short==4){
                        $("#contact_wjs").attr("class","sort_asc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","")
                    }else if(short==5){
                        $("#contactWay_wjs").attr("class","sort_asc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","")
                    }else if(short==6){
                        $("#chassisNumber_wjs").attr("class","sort_asc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class",""); $("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","")
                    }else if(short==7){
                        $("#carLicenseNumber_wjs").attr("class","sort_asc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","")
                    }else if(short==8){
                        $("#coverTypeName_wjs").attr("class","sort_asc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class",""); $("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","")
                    }else if(short==9){
                        $("#jqxrqEnd_wjs").attr("class","sort_asc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","")
                    }else if(short==10){
                        $("#bhInsuranceEndDate_wjs").attr("class","sort_asc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","")
                    }else if(short==11){
                        $("#customerLevel_wjs").attr("class","sort_asc");
                        $("#gotThroughNum_wjs").attr("class",""),$("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");
                        $("#chassisNumber_wjs").attr("class","");$("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","")
                    }else if(short==12){
                        $("#gotThroughNum_wjs").attr("class","sort_asc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                    }else if(short==13){
                        $("#willingTraceDate_wjs").attr("class","sort_asc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                    }else if(short==14){
                        $("#lastTraceDate_wjs").attr("class","sort_asc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                    }else if(short==15){
                        $("#lastTraceResult_wjs").attr("class","sort_asc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                    }else if(short==16){
                        $("#delayDate_wjs").attr("class","sort_asc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                    }else if(short==17){
                        $("#remainLostInsurDay_wjs").attr("class","sort_asc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#cyts_wjs").attr("class","");$("#holder_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                    }else if(short==18){
                        $("#cyts_wjs").attr("class","sort_desc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#holder_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
                    }else if(short==19){
                        $("#holder_wjs").attr("class","sort_asc")
                        $("#principal_wjs").attr("class","");$("#clerk_wjs").attr("class","");$("#contact_wjs").attr("class","");$("#contactWay_wjs").attr("class","");$("#chassisNumber_wjs").attr("class","");
                        $("#carLicenseNumber_wjs").attr("class","");$("#coverTypeName_wjs").attr("class","");$("#jqxrqEnd_wjs").attr("class","");$("#bhInsuranceEndDate_wjs").attr("class","");
                        $("#willingTraceDate_wjs").attr("class","");$("#gotThroughNum_wjs").attr("class","");$("#lastTraceDate_wjs").attr("class","");$("#lastTraceResult_wjs").attr("class","");$("#delayDate_wjs").attr("class","");
                        $("#remainLostInsurDay_wjs").attr("class","");$("#cyts_wjs").attr("class","");$("#customerLevel_wjs").attr("class","");
            ...
            $scope.findByAcceptStatu = function(pageType,acceptStatu){
                ...
                $("#msgwindow").show();
                customerSCService.findByAcceptStatu($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
            ...
            $scope.findByReturnStatu = function(pageType,returnStatu){
                ...
                $("#msgwindow").show();
                if(returnStatu=='3,7'){
                    customerSCService.findByApproval($scope.condition).then(function (result) {
                            $("#msgwindow").hide();
                            if (result.status == 'OK'&&result.results.content.status=='OK') {
                                $scope.customerAll = result.results.content.list;
                                $scope.policyCount = result.results.content.policyCount;
                    ...
                    customerSCService.findByYiHuiTui($scope.condition).then(function (result) {
                            $("#msgwindow").hide();
                            if (result.status == 'OK'&&result.results.content.status=='OK') {
                                $scope.customerAll = result.results.content.list;
                                $scope.policyCount = result.results.content.policyCount;
                    ...
                    customerSCService.findByReturnStatu($scope.condition)
                        .then(function (result) {
                            $("#msgwindow").hide();
                            if (result.status == 'OK'&&result.results.content.status=='OK') {
                                $scope.customerAll = result.results.content.list;
            ...
            $scope.findDdwcdCus = function(pageType,pageStatus){
                ...
                $("#msgwindow").show();
                customerSCService.findDdwcdCus($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.customerAll = result.results.content.list;
            ...
            $scope.qjsort = function(short){
                ...
                if(shortmain%2==0){
                    $scope.shortmain=2;
                    if(short==2){
                        $("#principal").attr("class","sort_desc")
                        $("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");$("#customerLevel").attr("class","");
                        ...
                        $("#clerk").attr("class","sort_desc")
                        $("#principal").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");$("#customerLevel").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","")
                    }else if(short==4){
                        $("#contact").attr("class","sort_desc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");$("#customerLevel").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","")
                    }else if(short==5){
                        $("#contactWay").attr("class","sort_desc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#chassisNumber").attr("class","");$("#customerLevel").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","")
                    }else if(short==6){
                        $("#chassisNumber").attr("class","sort_desc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#customerLevel").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class",""); $("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","")
                    }else if(short==7){
                        $("#carLicenseNumber").attr("class","sort_desc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");$("#customerLevel").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","")
                    }else if(short==8){
                        $("#coverTypeName").attr("class","sort_desc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");$("#customerLevel").attr("class","");
                        $("#willingTraceDate").attr("class",""); $("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","")
                    }else if(short==9){
                        $("#jqxrqEnd").attr("class","sort_desc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#bhInsuranceEndDate").attr("class","");$("#customerLevel").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","")
                    }else if(short==10){
                        $("#bhInsuranceEndDate").attr("class","sort_desc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#customerLevel").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","")
                    }else if(short==11){
                        $("#customerLevel").attr("class","sort_desc");
                        $("#gotThroughNum").attr("class",""),$("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");
                        $("#chassisNumber").attr("class","");$("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","")
                    }else if(short==12){
                        $("#gotThroughNum").attr("class","sort_desc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","");$("#customerLevel").attr("class","");
                    }else if(short==13){
                        $("#willingTraceDate").attr("class","sort_desc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","");$("#customerLevel").attr("class","");
                    }else if(short==14){
                        $("#lastTraceDate").attr("class","sort_desc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","");$("#customerLevel").attr("class","");
                    }else if(short==15){
                        $("#lastTraceResult").attr("class","sort_desc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","");$("#customerLevel").attr("class","");
                    }else if(short==16){
                        $("#delayDate").attr("class","sort_desc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","");$("#customerLevel").attr("class","");
                    }else if(short==17){
                        $("#remainLostInsurDay").attr("class","sort_desc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#cyts").attr("class","");$("#holder").attr("class","");$("#customerLevel").attr("class","");
                    }else if(short==18){
                        $("#cyts").attr("class","sort_asc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#holder").attr("class","");$("#customerLevel").attr("class","");
                    }else if(short==19){
                        $("#holder").attr("class","sort_desc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#customerLevel").attr("class","");
                    }
                }
                else{
                    $scope.shortmain=1;
                    if(short==2){
                        $("#principal").attr("class","sort_asc")
                        $("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");$("#customerLevel").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","")
                    }else if(short==3){
                        $("#clerk").attr("class","sort_asc")
                        $("#principal").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");$("#customerLevel").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","")
                    }else if(short==4){
                        $("#contact").attr("class","sort_asc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");$("#customerLevel").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","")
                    }else if(short==5){
                        $("#contactWay").attr("class","sort_asc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#chassisNumber").attr("class","");$("#customerLevel").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","")
                    }else if(short==6){
                        $("#chassisNumber").attr("class","sort_asc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#customerLevel").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class",""); $("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","")
                    }else if(short==7){
                        $("#carLicenseNumber").attr("class","sort_asc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");$("#customerLevel").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","")
                    }else if(short==8){
                        $("#coverTypeName").attr("class","sort_asc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");$("#customerLevel").attr("class","");
                        $("#willingTraceDate").attr("class",""); $("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","")
                    }else if(short==9){
                        $("#jqxrqEnd").attr("class","sort_asc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#bhInsuranceEndDate").attr("class","");$("#customerLevel").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","")
                    }else if(short==10){
                        $("#bhInsuranceEndDate").attr("class","sort_asc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#customerLevel").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","")
                    }else if(short==11){
                        $("#customerLevel").attr("class","sort_asc");
                        $("#gotThroughNum").attr("class",""),$("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");
                        $("#chassisNumber").attr("class","");$("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","")
                    }else if(short==12){
                        $("#gotThroughNum").attr("class","sort_asc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","");$("#customerLevel").attr("class","");
                    }else if(short==13){
                        $("#willingTraceDate").attr("class","sort_asc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","");$("#customerLevel").attr("class","");
                    }else if(short==14){
                        $("#lastTraceDate").attr("class","sort_asc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","");$("#customerLevel").attr("class","");
                    }else if(short==15){
                        $("#lastTraceResult").attr("class","sort_asc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","");$("#customerLevel").attr("class","");
                    }else if(short==16){
                        $("#delayDate").attr("class","sort_asc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#holder").attr("class","");$("#customerLevel").attr("class","");
                    }else if(short==17){
                        $("#remainLostInsurDay").attr("class","sort_asc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#cyts").attr("class","");$("#holder").attr("class","");$("#customerLevel").attr("class","");
                    }else if(short==18){
                        $("#cyts").attr("class","sort_desc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#holder").attr("class","");$("#customerLevel").attr("class","");
                    }else if(short==19){
                        $("#holder").attr("class","sort_asc")
                        $("#principal").attr("class","");$("#clerk").attr("class","");$("#contact").attr("class","");$("#contactWay").attr("class","");$("#chassisNumber").attr("class","");
                        $("#carLicenseNumber").attr("class","");$("#coverTypeName").attr("class","");$("#jqxrqEnd").attr("class","");$("#bhInsuranceEndDate").attr("class","");
                        $("#willingTraceDate").attr("class","");$("#gotThroughNum").attr("class","");$("#lastTraceDate").attr("class","");$("#lastTraceResult").attr("class","");$("#delayDate").attr("class","");
                        $("#remainLostInsurDay").attr("class","");$("#cyts").attr("class","");$("#customerLevel").attr("class","");
            ...
            $scope.findByCondition = function(){
                ...
                if( insurDateLYStart != null  && insurDateLYEnd != null && insurDateLYStart != ""  && insurDateLYEnd != "" && insurDateLYStart>insurDateLYEnd){
                    ...
                    $("#msgwindow").show();
                    customerSCService.findByCondition($scope.conditionSearch)
                        .then(function (result) {
                            $("#msgwindow").hide();
                            if (result.status == 'OK' && result.results.content.status == 'OK') {
                                $("#msgwindow").hide();
            ...
            $scope.findByCustomerId=function(customer){
                ...
                $scope.genzcl = {};
                $("#msgwindow").show();
                customerSCService.findByCustomerId($scope.customerId).then(function (result) {
                    $("#msgwindow").hide();
            ...
            $scope.findListCustomerBJRecode = function() {
                customerSCService.findListCustomerBJRecode($scope.customerId).then(function (result) {
                    if (result.status == 'OK' && result.results.success == true) {
            ...
            $scope.findApprovalBillRecordList = function() {
                customerSCService.findApprovalBillRecordList($scope.chassisNumber).then(function (result) {
                    if (result.status == 'OK' && result.results.success == true) {
            ...
            $scope.saveChange = function(){
                ...
                $scope.updateCustMsg = function(){
                    $("#msgwindow").show();
                    customerSCService.updateCustomerInfo(updateData,$scope.principalId,$scope.principal).then(function(result){
                        $("#msgwindow").hide();
                        if(result.status == 'OK'){
                            $("#changevalue").hide();
            ...
            $scope.gzclmr = function (carBrand,vehicleModel){
                var sfyy = 0 ;
                $scope.carBrandsgz = [];
                Array.prototype.push.apply($scope.carBrandsgz,$scope.carBrands);
            ...
            $scope.addNewTraceInitFun = function(){
                $scope.newTrace = {};
                $scope.newTrace.sfgyx = $scope.genzcl.sfgyx;
                if($scope.genzcl.customerLevel){
                    $scope.newTrace.customerLevel=$scope.genzcl.customerLevel;
            ...
            $scope.addNewTrace = function(traceFlag){
                ...
                var customerId = $scope.customerId;
                var lxr = $scope.genzcl.contact;
                var lxfs = $scope.genzcl.contactWay;
                var cx = '';
                if($scope.genzcl.carBrand&&$scope.genzcl.carBrand.brandName == '异系'){
                    cx = $scope.genzcl.vehicleModelInput
                }else{
                    if($scope.genzcl.vehicleModel){
                        cx = $scope.genzcl.vehicleModel.modelName
                    }
                }
                var quote = '';
                var quotedPrice = '';
                var comeStore = '';
                var customerLevel = $scope.newTrace.customerLevel;
                var bxdqr = $scope.genzcl.jqxrqEnd;
                var principal = $scope.genzcl.principal;
                var principalId = $scope.genzcl.principalId;
                var renewalType = $filter('mapTBLX')($scope.genzcl.renewalType);
            ...
            $scope.traceSubmit = function(newTraceDatas,traceFlag,htyy,htyyxz){
                ...
                $scope.gzMsgValuebol = true;
                $("#msgwindow").show();
                customerSCService.addTraceRecord(newTraceDatas,traceFlag,htyy,htyyxz)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK' && result.results.content.status == 'OK') {
            ...
            $scope.traceFinishHandleFun = function(){
                customerSCService.findGzCount($scope.customerId)
                    .then(function (res) {
                        ...
                        if(gzCount<=0){
                            ...
                            $("#msgwindow").show();
                            customerSCService.traceFinishHandle($scope.customerId,$scope.principalId,$scope.principal)
                                .then(function (result) {
                                    $("#msgwindow").hide();
                                    if (result.status == 'OK') {
                                        if($scope.pageType!='qkcx'){
            ...
            $scope.traceReturnFun = function(){
                ...
                $scope.makesure = function() {
                    ...
                    $("#ht").hide();
                    $("#msgwindow").show();
                    customerSCService.traceReturn($scope.customerId, $scope.confirmData.htyy,$scope.principalId,$scope.principal)
                        .then(function (result) {
                            $("#msgwindow").hide();
                            if (result.status == 'OK'&& result.results.content.status == 'OK') {
                                $scope.$emit("CountByUserIdTop", true);
            ...
            $scope.updateAcceptStatu = function(){
                $("#msgwindow").show();
                customerSCService.updateAcceptStatu($scope.customerId,$scope.principalId,$scope.principal)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
            ...
            $scope.AcceptStatusubmit = function() {
                ...
                if(SelectedCount == 0){
                    ...
                    $("#msgwindow").show();
                    customerSCService.updateAcceptStatuBatch($scope.AcceptDatas).then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.angularTip("接收成功",5000);
                            for (var i=0;i<SelectedCount;i++){
            ...
            $scope.open_BJ = function(){
                ...
                customerSCService.findBxInfoForBH( $scope.customerId).then(function(result){
                    if (result.status == 'OK' && result.results.success == true) {
            ...
            $scope.searchMoldName = function(){
                ...
                $("#msgwindow").show();
                customerSCService.getModels(Data).then(function (result) {
                    $("#msgwindow").hide();
                    if (result.status == 'OK') {
            ...
            $scope.bihuQuote_b = function(bjType){
                ...
                $("#msgwindow").show();
                if(bhinscomBol == 1){
                    customerSCService.bihuApplyBJ(quoteDatas).then(function(result){
                        $("#msgwindow").hide();
                        if(result.status == 'OK'&&result.results.success==true){
            ...
            $scope.bofideQuote = function(bjType){
                ...
                $("#msgwindow").show();
                if(bhinscomBol == 1){
                    customerSCService.applyBJFromBofide(args).then(function(result){
                        $("#msgwindow").hide();
                        if(result.status == 'OK'&&result.results.success==true){
                            $scope.bihuquote = result.results.content.results;
                            $scope.bihuquote.PayAmount = 0;
            ...
            $scope.saveQuote = function(){
                ...
                $("#msgwindow").show();
                customerSCService.bihuSaveBJ(saveBj).then(function(result){
                    $("#msgwindow").hide();
                    if(result.status == 'OK'){
                        $scope.closeNew_bj();
                        $scope.angularTip(result.results.message,5000)
            ...
            $scope.manual = function(flag){
                ...
                $("#msgwindow").show();
                customerSCService.manual(condition).then(function (result) {
                    $("#msgwindow").hide();
                    if (result.status == 'OK'&&result.results.content.status=='OK') {
            ...
            $scope.findwxRecordByCondition = function(){
                ...
                customerSCService.findwxRecordByCondition($scope.condition)
                    .then(function (result) {
            ...
            $scope.maintainDetails=function(maintainNumber){
                ...
                $("#msgwindow").show();
                customerSCService.findByMaintainNumber($scope.maintainNumber).then(function (result) {
                    $("#msgwindow").hide();
                    if (result.status == 'OK'&&result.results.content.status=='OK') {
            ...
            $scope.findByConditionTSX = function(){
                ...
                customerSCService.findByConditionTSX($scope.condition)
                    .then(function (result) {
            ...
            $scope.pushDetails=function(reportNumber){
                ...
                $("#msgwindow").show();
                customerSCService.findPMaintenanceByRNumber($scope.reportNumber).then(function (result) {
                    $("#msgwindow").hide();
                    if (result.status == 'OK'&&result.results.content.status=='OK') {
                        $("#pushDetailAll").show();
