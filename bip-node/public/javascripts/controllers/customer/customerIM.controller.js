...
angular.module('myApp')
    .controller('customerIM_Controller',['$rootScope','$scope','$filter','customerIMService','$state',
        function($rootScope,$scope,$filter,customerIMService,$state){
            // 保险经理
            ...
            //按4s店ID查询车辆品牌车型信息
            customerIMService.findCarInfoByStoreId().then(function(res){
            ...
            //根据4s店id查询保险公司信息
            customerIMService.findCompInfoByStoreId().then(function(res){
            ...
            //查询建档人
            customerIMService.selectUserForJdrDataSource().then(function(res){
                if(res.status == 'OK'&&res.results.content.status=='OK'){
            ...
            //查询本店各种用户
            customerIMService.findKindsUser().then(function(res){
                if(res.status == 'OK'&&res.results.content.status=='OK'){
            ...
            //查询持有人列表
            customerIMService.selectUserForHolderSearch().then(function(res){
                if(res.status == 'OK'&&res.results.content.status=='OK'){
            ...
            $scope.forbiddenOrRegain = function(obj){
                if(obj.userStatus != 2){
                    ...
                    $scope.makeSure = function() {
                        $("#pause").hide();
                        $("#msgwindow").show();
                        customerIMService.pauseOrForbidden(obj.userId,2).then(function(res){
                            $("#msgwindow").hide();
                            if(res.status == 'OK'){
                    ...
                    $scope.makeSure = function() {
                        $("#pause").hide();
                        $("#msgwindow").show();
                        customerIMService.pauseOrForbidden(obj.userId,0).then(function(res){
                            $("#msgwindow").hide();
                            if(res.status == 'OK'){
            ...
            $scope.pauseOrRegain = function(obj){
                ...
                if(obj.userStatus == 0){
                    ...
                    $scope.makeSure = function() {
                        $("#pause").hide();
                        customerIMService.pauseOrForbidden(obj.userId,1).then(function(res){
                            if(res.status == 'OK'){
            ...
            $scope.findInsuranceStatistics = function(pageType){
                ...
                $("#msgwindow").show();
                customerIMService.findInsuranceStatistics($scope.startTime,$scope.endTime,$scope.showAll).then(function(result){
                    $("#msgwindow").hide();
                    if (result.status == 'OK') {
            ...
            $scope.findSaleStatistics = function(pageType){
                ...
                $("#msgwindow").show();
                customerIMService.findSaleStatistics($scope.startTime,$scope.endTime,$scope.showAll).then(function(result){
                    $("#msgwindow").hide();
                    if (result.status == 'OK') {
            ...
            $scope.findServiceStatistics = function(pageType){
                ...
                $("#msgwindow").show();
                customerIMService.findServiceStatistics($scope.startTime,$scope.endTime,$scope.showAll).then(function(result){
                    $("#msgwindow").hide();
                    if (result.status == 'OK') {
            ...
            $scope.findkefu = function(pageType){
                ...
                $("#msgwindow").show();
                customerIMService.findCSCStatistics($scope.startTime,$scope.endTime,$scope.showAll).then(function(result){
                    $("#msgwindow").hide();
                    if (result.status == 'OK') {
            ...
            $scope.findIWStatistics = function(pageType){
                ...
                $("#msgwindow").show();
                customerIMService.findIWStatistics($scope.startTime,$scope.endTime,$scope.showAll).then(function(result){
                    $("#msgwindow").hide();
                    if (result.status == 'OK') {
            ...
            $scope.getSearchByTime = function (){
                ...
                if(!(re_data.test($scope.startTime)) || !(re_data.test($scope.endTime))){
                    ...
                    if($scope.pageType=='gz'){
                        ...
                        $scope.findInviteStatuIM('yyjl',$scope.pageStatus);//邀约记录
            ...
            $scope.qjsort_statu = function(short){
                ...
                if($scope.pageType=='gz'){
                    ...
                    this.findInviteStatuIM('yyjl',$scope.pageStatus);//邀约记录
                }else if($scope.pageType=='ht'){
            ...
            $scope.findByTraceStatu = function(pageType,traceStatu){
                ...
                $("#msgwindow").show();
                customerIMService.findByTraceStatu($scope.condition)
            ...
            $scope.findByCusLostInsurStatu = function(pageType,cusLostInsurStatu){
                ...
                $("#msgwindow").show();
                customerIMService.findByCusLostInsurStatu($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.customerAll = result.results.content.list;
            ...
            //查询潜客邀约记录
            $scope.findInviteStatuIM = function(pageType,inviteStatu){
                $scope.rightTitleTimeToolShow();
                var short=$scope.short;
                var shortmain=$scope.shortmain;
                var renewalType = $scope.qkSearch.renewalType;
                ...
                $("#msgwindow").show();
                customerIMService.findInviteStatuIM($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
            ...
            $scope.findByAcceptStatu = function(pageType,acceptStatu){
                ...
                $("#msgwindow").show();
                customerIMService.findByAcceptStatu($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.customerAll = result.results.content.list;
            ...
            $scope.findByReturnStatu = function(pageType,returnStatu){
                ...
                $("#msgwindow").show();
                if(returnStatu==2){
                    customerIMService.findByYiHuiTui($scope.condition)
                        .then(function (result) {
                            $("#msgwindow").hide();
                            if (result.status == 'OK'&&result.results.content.status=='OK') {
                                $scope.customerAll = result.results.content.list;
                    ...
                    customerIMService.findByReturnStatu($scope.condition)
                        .then(function (result) {
                            $("#msgwindow").hide();
                            if (result.status == 'OK'&&result.results.content.status=='OK') {
                                $scope.customerAll = result.results.content.list;
            ...
            $scope.findByApprovalStatu = function(pageType,approvalStatu){
                ...
                $("#msgwindow").show();
                customerIMService.findByApprovalStatu($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.customerAll = result.results.content.list;
            ...
            $scope.findActivateCustomer = function(pageType,returnStatu){
                ...
                $("#msgwindow").show();
                customerIMService.findActivateCustomer($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
            ...
            $scope.findByJiHuo = function(pageType,pageStatus){
                ...
                $("#msgwindow").show();
                customerIMService.findByJiHuo($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.customerAll = result.results.content.list;
            ...
            $scope.findDdwcdCus = function(pageType,pageStatus){
                ...
                $("#msgwindow").show();
                customerIMService.findDdwcdCus($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.customerAll = result.results.content.list;
            ...
            $scope.findByCondition = function() {
                ...
                if( insuDateStartTime != null  && insuDateEndTime != null && insuDateStartTime != ""  && insuDateEndTime != "" && insuDateStartTime>insuDateEndTime){
                    ...
                    $("#msgwindow").show();
                    customerIMService.findByCondition($scope.conditionSearch).then(function (result) {
                        $("#msgwindow").hide();
            ...
            $scope.findByCustomerId=function(customer){
                ...
                $("#msgwindow").show();
                customerIMService.findByCustomerId( $scope.customerId).then(function (result) {
                    $("#msgwindow").hide();
                    if (result.status == 'OK'&&result.results.content.status=='OK') {
                        $("#genzcl").show();
                        $("#clxhxz_gzcl").show();
            ...
            $scope.findListCustomerBJRecode = function() {
                customerIMService.findListCustomerBJRecode($scope.customerId).then(function (result) {
            ...
            $scope.findApprovalBillRecordList = function() {
                customerIMService.findApprovalBillRecordList($scope.chassisNumber).then(function (result) {
                    if (result.status == 'OK' && result.results.success == true) {
            ...
            $scope.findwxRecordByCondition = function(){
                ...
                customerIMService.findwxRecordByCondition($scope.condition)
                    .then(function (result) {
            ...
            $scope.maintainDetails=function(maintainNumber){
                ...
                $("#msgwindow").show();
                customerIMService.findByMaintainNumber($scope.maintainNumber).then(function (result) {
                    $("#msgwindow").hide();
                    if (result.status == 'OK'&&result.results.content.status=='OK') {
            ...
            $scope.findByConditionTSX = function(){
                ...
                customerIMService.findByConditionTSX($scope.condition)
                    .then(function (result) {
            ...
            $scope.pushDetails=function(reportNumber){
                ...
                $("#msgwindow").show();
                customerIMService.findPMaintenanceByRNumber($scope.reportNumber).then(function (result) {
                    $("#msgwindow").hide();
                    if (result.status == 'OK'&&result.results.content.status=='OK') {
                        $("#pushDetailAll").show();
