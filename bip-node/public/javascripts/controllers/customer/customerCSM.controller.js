...
angular.module('myApp')
    .controller('customerCSM_Controller',['$rootScope','constant','$location','$scope','$filter','customerCSMService','$state','ExportExcel',
        function($rootScope,constant,$location,$scope,$filter,customerCSMService,$state,ExportExcel){
            //客服经理
            ...
            $scope.$on('pageStatus', function(e, pageTypeStatus) {
                if(pageTypeStatus.pageTypeStatus == 'kefu'){
                    $scope.showAll = false;
                }else {
                    $scope.showAll = true;
                };
            ...
            //按4s店ID查询车辆品牌车型信息
            customerCSMService.findCarInfoByStoreId().then(function(res){
            ...
            //根据4s店id查询保险公司信息
            customerCSMService.findCompInfoByStoreId().then(function(res){
            ...
            //查询本店各种用户
            customerCSMService.findKindsUser().then(function(res){
                if(res.status == 'OK'&&res.results.content.status=='OK'){
            ...
            //查询持有人列表
            customerCSMService.selectUserForHolderSearch().then(function(res){
                if(res.status == 'OK'&&res.results.content.status=='OK'){
            ...
            $scope.forbiddenOrRegain = function(obj,roleId){
                if(obj.userStatus != 2){
                    ...
                    $scope.makeSure = function() {
                        $("#pause").hide();
                        $("#msgwindow").show();
                        customerCSMService.pauseOrForbidden(obj.userId,2,roleId).then(function(res){
                            $("#msgwindow").hide();
                            if(res.status == 'OK'){
                    ...
                    $scope.makeSure = function() {
                        $("#pause").hide();
                        $("#msgwindow").show();
                        customerCSMService.pauseOrForbidden(obj.userId,0).then(function(res){
                            $("#msgwindow").hide();
                            if(res.status == 'OK'){
            ...
            $scope.pauseOrRegain = function(obj){
                ...
                if(obj.userStatus == 0){
                    ...
                    $scope.makeSure = function() {
                        $("#pause").hide();
                        customerCSMService.pauseOrForbidden(obj.userId,1).then(function(res){
                            if(res.status == 'OK'){
            ...
            $scope.findkefu = function(pageType){
                ...
                $("#msgwindow").show();
                customerCSMService.findCSCStatistics($scope.startTime,$scope.endTime,$scope.showAll).then(function(result){
                    $("#msgwindow").hide();
                    if (result.status == 'OK') {
            ...
            $scope.findBspDefeatCustomer = function(pageType){
                ...
                $scope.resetPageData();
                $("#msgwindow").show();
                customerCSMService.findDefeatCustomer(short,shortmain,$scope.startTime,$scope.endTime,$scope.startNum,$scope.showAll,sxyy)
            ...
            $scope.getSearchMroe = function (){
                ...
                if($scope.pageType=='js'){
                    ...
                    $scope.findBspDefeatCustomer('bspcx');
                }
            };
            ...
            $scope.qjsort_statu = function(short){
                ...
                if($scope.pageType=='js'){
                    ...
                    this.findkefu('kefu')//客服统计
                }else if($scope.pageType=='bspcx'){
                    this.findBspDefeatCustomer('bspcx') //bsp战败潜客
                }
            };
            //根据回退状态查询
            $scope.findByReturnStatu = function(pageType,returnStatu){
                ...
                $("#msgwindow").show();
                customerCSMService.findByReturnStatu($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
            ...
            $scope.findByAcceptStatu = function(pageType,acceptStatu){
                ...
                $("#msgwindow").show();
                customerCSMService.findByAcceptStatu($scope.condition)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.customerAll = result.results.content.list;
            ...
            $scope.findByCondition = function(){
                ...
                if( insurDateLYStart != null  && insurDateLYEnd != null && insurDateLYStart != ""  && insurDateLYEnd != "" && insurDateLYStart>insurDateLYEnd){
                    ...
                    $("#msgwindow").show();
                    customerCSMService.findByCondition( $scope.conditionSearch)
                        .then(function (result) {
                            $("#msgwindow").hide();
                            if (result.status == 'OK' && result.results.content.status == 'OK') {
                                $("#msgwindow").hide();
            ...
            $scope.findByCustomerId=function(customer){
                ...
                $("#msgwindow").show();
                customerCSMService.findByCustomerId( $scope.customerId).then(function (result) {
                    $("#msgwindow").hide();
                    if (result.status == 'OK'&&result.results.content.status=='OK') {
                        $("#genzcl").show();
                        $("#clxhxz_gzcl").show();
                ...
                customerCSMService.findAllSubordinate(customer.principalId).then(function (result) {
            ...
            $scope.findApprovalBillRecordList = function() {
                customerCSMService.findApprovalBillRecordList($scope.chassisNumber).then(function (result) {
            ...
            $scope.replacePrincipal = function(){
                $("#ghfzr").show();
                $scope.makesure = function() {
                    if(!$scope.confirmData.ghfzr){
                        $scope.angularTip("原因不能为空",5000);
                        return;
                    }
                    $("#ghfzr").hide();
                    customerCSMService.replacePrincipal($scope.newPrincipal.principal.id,
                        $scope.newPrincipal.principal.userName, $scope.customerId, $scope.principalId,
                        $scope.confirmData.ghfzr)
                        .then(function (result) {
                            if (result.status == 'OK' && result.results.content.status == 'OK') {
            ...
            $scope.findwxRecordByCondition = function(){
                ...
                customerCSMService.findwxRecordByCondition($scope.condition)
                    .then(function (result) {
            ...
            $scope.maintainDetails=function(maintainNumber){
                ...
                $("#msgwindow").show();
                customerCSMService.findByMaintainNumber($scope.maintainNumber).then(function (result) {
                    $("#msgwindow").hide();
                    if (result.status == 'OK'&&result.results.content.status=='OK') {
            ...
            $scope.findByConditionTSX = function(){
                ...
                customerCSMService.findByConditionTSX($scope.condition)
                    .then(function (result) {
            ...
            $scope.pushDetails=function(reportNumber){
                ...
                $("#msgwindow").show();
                customerCSMService.findPMaintenanceByRNumber($scope.reportNumber).then(function (result) {
                    $("#msgwindow").hide();
                    if (result.status == 'OK'&&result.results.content.status=='OK') {
                        $("#pushDetailAll").show();
            ...
            $scope.getExportData = function () {
                if($scope.pageType == 'bspcx'){
                    $scope.findBspDefeatCustomerExport('bspcx') //战败潜客查询
                }else if($scope.pageType == 'ht'){
                    $scope.findByReturnStatuExport('ht', $scope.pageStatus)//已失销
                }
            ...
            $scope.findByReturnStatuExport = function(pageType,returnStatu){
                ...
                customerCSMService.findByReturnStatu(condition)
                    .then(function (result) {
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
            ...
            $scope.findBspDefeatCustomerExport = function(pageType){
                ...
                $scope.pageType = pageType;
                var sxyy =  $scope.zbqk.sxyy;
                customerCSMService.findDefeatCustomer($scope.startTime,$scope.endTime,$scope.startNumExport,$scope.showAll,sxyy)
                    .then(function (result) {
                        if (result.status == 'OK'&&result.results.content.status=='OK') {
                            $scope.getExportDataCallback(result.results.content.list,result.results.content.policyCount);
                        }
