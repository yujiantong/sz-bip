...
angular.module('myApp')
    .controller('giftRecordGM_Controller',['$rootScope','$scope','$filter','giftRecordGMService',
        function($rootScope,$scope,$filter,giftRecordGMService,$state) {
            $scope.customerAll = [];
            ...
            $scope.findGivingCont = function(){
                ...
                $("#msgwindow").show();
                giftRecordGMService.findGivingByCondition($scope.condition)
            ...
            $scope.giftDetails=function(rowData){
                ...
                $("#msgwindow").show();
                giftRecordGMService.findGivingByApprovalBillId($scope.approvalBillId).then(function (result) {
                    $("#msgwindow").hide();
                    $("#hxdetail").show();
                    if (result.status == 'OK'&&result.results.content.status=='OK') {
            ...
            //查询本店各种用户
            giftRecordGMService.findKindsUser().then(function(res){
            ...
            $scope.exportToExcel=function(){
                ...
                var creatingFile =$scope.$watch("loadDataFinish", function(newValue, oldValue) {
                    ...
                    if ($scope.loadDataFinish) {
                        ...
                        setTimeout(function(){
                            giftRecordGMService.exportGiftRecordExcel($scope.exportCustomerData,$scope.exportData);
                            if(!$scope.finaLoadDataFinish){
                    ...
                    .then(function (result) {
                        ...
                        if (result.status == 'OK' && result.results.content.status == 'OK') {
                            ...
                            if(result.results.content.results.length > 0){
                                ...
                                giftRecordGMService.exportGiftRecord(condition).then(function (resultCustomer){
