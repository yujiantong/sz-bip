...
angular.module('myApp')
    .controller('performanceGM_Controller',['$rootScope','$scope','$filter','$state','$interval','performanceGMService',
        function($rootScope,$scope,$filter,$state,$interval,performanceGMService) {
            $scope.pageType="xb";
            $scope.coverType = 1;
            ...
            //初始化
            performanceGMService.statisticalNewInsurance($scope.coverType,$scope.statisticTime).then(function(result){
            ...
            $scope.statisticalXbInsurance = function(pageType,coverType){
                ...
                $("#msgwindow").show();
                performanceGMService.statisticalNewInsurance($scope.coverType,$scope.statisticTime)
            ...
            $scope.statisticalAllInsurance = function(pageType,renewalType){
                ...
                $("#msgwindow").show();
                performanceGMService.statisticalAllInsurance($scope.renewalType,$scope.statisticTime)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK' && result.results.content.status=='OK') {
            ...
            $scope.statisticalXinzxInsurance = function(pageType,renewalType){
                ...
                $scope.otherInsuranceTypeAll= [];
                $("#msgwindow").show();
                performanceGMService.statisticalXinzxInsurance($scope.renewalType,$scope.statisticTime)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK' && result.results.content.status=='OK') {
                            $scope.otherInsuranceTypeAll = result.results.content.listMap;
            ...
            $scope.statisticalXuzxInsurance = function(pageType,renewalType){
                ...
                $scope.otherInsuranceTypeAll= [];
                $("#msgwindow").show();
                performanceGMService.statisticalXuzxInsurance($scope.renewalType,$scope.statisticTime)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK' && result.results.content.status=='OK') {
                            $scope.otherInsuranceTypeAll = result.results.content.listMap;
            ...
            $scope.statisticalJianzxInsurance = function(pageType,renewalType){
                ...
                $scope.otherInsuranceTypeAll= [];
                $("#msgwindow").show();
                performanceGMService.statisticalJianzxInsurance($scope.renewalType,$scope.statisticTime)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK' && result.results.content.status=='OK') {
                            $scope.otherInsuranceTypeAll = result.results.content.listMap;
            ...
            $scope.statisticalQianzxInsurance = function(pageType,renewalType){
                ...
                $scope.otherInsuranceTypeAll= [];
                $("#msgwindow").show();
                performanceGMService.statisticalQianzxInsurance($scope.renewalType,$scope.statisticTime)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK' && result.results.content.status=='OK') {
                            $scope.otherInsuranceTypeAll = result.results.content.listMap;
            ...
            $scope.statisticalFirstInsurance = function(pageType,renewalType){
                ...
                $scope.otherInsuranceTypeAll= [];
                $("#msgwindow").show();
                performanceGMService.statisticalFirstInsurance($scope.renewalType,$scope.statisticTime)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK' && result.results.content.status=='OK') {
                            $scope.otherInsuranceTypeAll = result.results.content.listMap;
