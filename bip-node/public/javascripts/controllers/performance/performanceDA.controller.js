...
angular.module('myApp')
    .controller('performanceDA_Controller',['$rootScope','$scope','$filter','$state','$interval','performanceDAService',
        function($rootScope,$scope,$filter,$state,$interval,performanceDAService) {
            $scope.pageType="xb";
            $scope.coverType = 1;
            ...
            //初始化
            performanceDAService.statisticalNewInsurance($scope.coverType,$scope.statisticTime).then(function(result){
            ...
            $scope.statisticalXbInsurance = function(pageType,coverType){
                ...
                $("#msgwindow").show();
                performanceDAService.statisticalNewInsurance($scope.coverType,$scope.statisticTime)
            ...
            $scope.statisticalAllInsurance = function(pageType,renewalType){
                ...
                $("#msgwindow").show();
                performanceDAService.statisticalAllInsurance($scope.renewalType,$scope.statisticTime)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK' && result.results.content.status=='OK') {
            ...
            $scope.statisticalXinzxInsurance = function(pageType,renewalType){
                ...
                $scope.otherInsuranceTypeAll= [];
                $("#msgwindow").show();
                performanceDAService.statisticalXinzxInsurance($scope.renewalType,$scope.statisticTime)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK' && result.results.content.status=='OK') {
                            $scope.otherInsuranceTypeAll = result.results.content.listMap;
            ...
            $scope.statisticalXuzxInsurance = function(pageType,renewalType){
                ...
                $scope.otherInsuranceTypeAll= [];
                $("#msgwindow").show();
                performanceDAService.statisticalXuzxInsurance($scope.renewalType,$scope.statisticTime)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK' && result.results.content.status=='OK') {
                            $scope.otherInsuranceTypeAll = result.results.content.listMap;
            ...
            $scope.statisticalJianzxInsurance = function(pageType,renewalType){
                ...
                $scope.otherInsuranceTypeAll= [];
                $("#msgwindow").show();
                performanceDAService.statisticalJianzxInsurance($scope.renewalType,$scope.statisticTime)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK' && result.results.content.status=='OK') {
                            $scope.otherInsuranceTypeAll = result.results.content.listMap;
            ...
            $scope.statisticalQianzxInsurance = function(pageType,renewalType){
                ...
                $scope.otherInsuranceTypeAll= [];
                $("#msgwindow").show();
                performanceDAService.statisticalQianzxInsurance($scope.renewalType,$scope.statisticTime)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK' && result.results.content.status=='OK') {
                            $scope.otherInsuranceTypeAll = result.results.content.listMap;
            ...
            $scope.statisticalFirstInsurance = function(pageType,renewalType){
                ...
                $scope.otherInsuranceTypeAll= [];
                $("#msgwindow").show();
                performanceDAService.statisticalFirstInsurance($scope.renewalType,$scope.statisticTime)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK' && result.results.content.status=='OK') {
                            $scope.otherInsuranceTypeAll = result.results.content.listMap;
