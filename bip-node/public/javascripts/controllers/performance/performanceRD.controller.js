...
angular.module('myApp')
    .controller('performanceRD_Controller',['$rootScope','$scope','$filter','$state','$interval','performanceRDService',
        function($rootScope,$scope,$filter,$state,$interval,performanceRDService) {
            $scope.pageType="xb";
            $scope.coverType = 1;
            $scope.renewalType = 0;
            ...
            //初始化
            performanceRDService.statisticalNewInsurance($scope.coverType,$scope.statisticTime).then(function(result){
            ...
            $scope.statisticalXbInsurance = function(pageType,coverType){
                ...
                $("#msgwindow").show();
                performanceRDService.statisticalNewInsurance($scope.coverType,$scope.statisticTime)
            ...
            $scope.statisticalAllInsurance = function(pageType,renewalType){
                ...
                $("#msgwindow").show();
                performanceRDService.statisticalAllInsurance($scope.renewalType,$scope.statisticTime)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK' && result.results.content.status=='OK') {
            ...
            $scope.statisticalXinzxInsurance = function(pageType,renewalType){
                ...
                $scope.otherInsuranceTypeAll= [];
                $("#msgwindow").show();
                performanceRDService.statisticalXinzxInsurance($scope.renewalType,$scope.statisticTime)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK' && result.results.content.status=='OK') {
                            $scope.otherInsuranceTypeAll = result.results.content.listMap;
            ...
            $scope.statisticalXuzxInsurance = function(pageType,renewalType){
                ...
                $scope.otherInsuranceTypeAll= [];
                $("#msgwindow").show();
                performanceRDService.statisticalXuzxInsurance($scope.renewalType,$scope.statisticTime)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK' && result.results.content.status=='OK') {
                            $scope.otherInsuranceTypeAll = result.results.content.listMap;
            ...
            $scope.statisticalJianzxInsurance = function(pageType,renewalType){
                ...
                $scope.otherInsuranceTypeAll= [];
                $("#msgwindow").show();
                performanceRDService.statisticalJianzxInsurance($scope.renewalType,$scope.statisticTime)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK' && result.results.content.status=='OK') {
                            $scope.otherInsuranceTypeAll = result.results.content.listMap;
            ...
            $scope.statisticalQianzxInsurance = function(pageType,renewalType){
                ...
                $scope.otherInsuranceTypeAll= [];
                $("#msgwindow").show();
                performanceRDService.statisticalQianzxInsurance($scope.renewalType,$scope.statisticTime)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK' && result.results.content.status=='OK') {
                            $scope.otherInsuranceTypeAll = result.results.content.listMap;
            ...
            $scope.statisticalFirstInsurance = function(pageType,renewalType){
                ...
                $scope.otherInsuranceTypeAll= [];
                $("#msgwindow").show();
                performanceRDService.statisticalFirstInsurance($scope.renewalType,$scope.statisticTime)
                    .then(function (result) {
                        $("#msgwindow").hide();
                        if (result.status == 'OK' && result.results.content.status=='OK') {
                            $scope.otherInsuranceTypeAll = result.results.content.listMap;
