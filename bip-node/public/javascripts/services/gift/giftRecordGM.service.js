...
angular.module('myApp')
    .service('giftRecordGMService', ['$http','$q', function($http,$q){
        //根据条件查询赠送核销记录
        ...
        this.exportGiftRecordExcel = function(exportCustomerData,exportData){
            ...
            overviewData.push([
                ...
                {"v": "", "s": {border: {top: {style: "thin"}, bottom: {style: "thin"}, left: {style: "thin"}, right:{style: "thin"}},font: {name: "宋体", sz: 10 , bold: true }, alignment: {horizontal: "center"}}},
                {"v": "", "s": {border: {top: {style: "thin"}, bottom: {style: "thin"}, left: {style: "thin"}, right:{style: "thin"}},font: {name: "宋体", sz: 10 , bold: true }, alignment: {horizontal: "center"}}},
                {"v": "", "s": {border: {top: {style: "thin"}, bottom: {style: "thin"}, left: {style: "thin"}, right:{style: "thin"}},font: {name: "宋体", sz: 10 , bold: true }, alignment: {horizontal: "center"}}},
                {"v": "", "s": {border: {top: {style: "thin"}, bottom: {style: "thin"}, left: {style: "thin"}, right:{style: "thin"}},font: {name: "宋体", sz: 10 , bold: true }, alignment: {horizontal: "center"}}},
                {"v": "", "s": {border: {top: {style: "thin"}, bottom: {style: "thin"}, left: {style: "thin"}, right:{style: "thin"}},font: {name: "宋体", sz: 10, bold: true  }, alignment: {horizontal: "center"}}},
            ...
            var membershipIntegralData = [];
                ...
                summaryDetailsData.push([
                    ...
                    {"v": "实际成本", "s": {border: {top: {style: "thin"}, bottom: {style: "thin"}, left: {style: "thin"}, right:{style: "thin"}},font: {name: "宋体", sz: 12, bold: true  }, alignment: {horizontal: "center"}}},
                ...
                for(var j=0;j<exportCustomerData.length;j++){
                    ...
                    if(exportCustomerData[j].givingInformationId==0 && approvalBillId == exportApprovalBillId){
                        ...
                        summaryDetailsData.push([
                            ...
                            {"v": parseFloat(actualPrice) , "s": {"numFmt" : "0.00" ,border: {top: {style: "thin"}, bottom: {style: "thin"}, left: {style: "thin"}, right:{style: "thin"}},font: {name: "宋体", sz: 10 }, alignment: {horizontal: "center", vertical: "center" , wrapText: "true"}}},
                        ...
                        if(giftType == 1){//服务类 serviceData
                            overviewInsertd11(serviceData , ++serviceIndexes , carLicenseNumber , chassisNumber ,  contact , contactWay, giftCode, giftName, validDate, guidePrice, actualPrice, sellingPrice, amount, amountMoney, insuranceBillId , cdrq, insuranceWriter , remark);
                        }else if(giftType == 2){//精品类 boutiqueData
                            overviewInsertd11(boutiqueData , ++boutiqueIndexes , carLicenseNumber , chassisNumber ,  contact , contactWay, giftCode, giftName, validDate, guidePrice, actualPrice, sellingPrice, amount, amountMoney, insuranceBillId , cdrq, insuranceWriter , remark);
                        }else if(giftType == 3){//礼包类 packagesData
                            overviewInsertd11(packagesData , ++packagesIndexes , carLicenseNumber , chassisNumber ,  contact , contactWay, giftCode, giftName, validDate, guidePrice, actualPrice, sellingPrice, amount, amountMoney, insuranceBillId , cdrq, insuranceWriter , remark);
                        }else if(giftType == 4){//储值卡类 storedCardData
                            overviewInsertd11(storedCardData , ++storedCardIndexes , carLicenseNumber , chassisNumber ,  contact , contactWay, giftCode, giftName, validDate, guidePrice, actualPrice, sellingPrice, amount, amountMoney, insuranceBillId , cdrq, insuranceWriter , remark);
                        }else if(giftType == 5){//会员积分类 membershipIntegralData
                            overviewInsertd11(membershipIntegralData , ++membershipIndexes , carLicenseNumber , chassisNumber ,  contact , contactWay, giftCode, giftName, validDate, guidePrice, actualPrice, sellingPrice, amount, amountMoney, insuranceBillId , cdrq, insuranceWriter , remark);
                        }
        ...
        //代码复用
        function overviewInsertd11(sheetData , mapIndex, carLicenseNumber , chassisNumber ,  contact, contactWay, giftCode, giftType , validDate , guidePrice , actualPrice , sellingPrice
