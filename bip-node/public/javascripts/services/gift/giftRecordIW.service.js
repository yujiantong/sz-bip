...
angular.module('myApp')
    .service('giftRecordIWService', ['$http','$q', function($http,$q){
        //根据条件查询赠送核销记录
        ...
        this.exportGiftRecordExcel = function(exportCustomerData,exportData){
            ...
            for(var i=0;i<exportData.length;i++){
                if(exportData[i].chassisNumber == "LVSHCADBXHE155023"){
                    console.log(exportData[i].chassisNumber)
                }
                ...
                for(var j=0;j<exportCustomerData.length;j++){
                    ...
                    if(exportCustomerData[j].givingInformationId==0 && approvalBillId == exportApprovalBillId){
                        ...
                        giftCode = exportCustomerData[j].giftCode;
                        giftType = exportCustomerData[j].giftType;
                        giftName = exportCustomerData[j].giftName;
                        validDate = exportCustomerData[j].validDate;
                        ...
                        amount = exportCustomerData[j].amount;
                        ...
                        summaryDetailsData.push([
                            ...
                            {"v": guidePrice , "s": {border: {top: {style: "thin"}, bottom: {style: "thin"}, left: {style: "thin"}, right:{style: "thin"}},font: {name: "宋体", sz: 10 }, alignment: {horizontal: "center", vertical: "center" , wrapText: "true"}}},
                            {"v": sellingPrice , "s": {border: {top: {style: "thin"}, bottom: {style: "thin"}, left: {style: "thin"}, right:{style: "thin"}},font: {name: "宋体", sz: 10 }, alignment: {horizontal: "center", vertical: "center" , wrapText: "true"}}},
                            ...
                            {"v": amountMoney , "s": {border: {top: {style: "thin"}, bottom: {style: "thin"}, left: {style: "thin"}, right:{style: "thin"}},font: {name: "宋体", sz: 10 }, alignment: {horizontal: "center", vertical: "center", wrapText: "true"}}},
                        ...
                        if(giftType == 1){//服务类 serviceData
                            overviewInsertd(serviceData , ++serviceIndexes , carLicenseNumber , chassisNumber ,  contact , contactWay, giftCode, giftName, validDate, guidePrice, sellingPrice, amount, amountMoney, insuranceBillId , cdrq, insuranceWriter , remark);
                        }else if(giftType == 2){//精品类 boutiqueData
                            overviewInsertd(boutiqueData , ++boutiqueIndexes , carLicenseNumber , chassisNumber ,  contact , contactWay, giftCode, giftName, validDate, guidePrice, sellingPrice, amount, amountMoney, insuranceBillId , cdrq, insuranceWriter , remark);
                        }else if(giftType == 3){//礼包类 packagesData
                            overviewInsertd(packagesData , ++packagesIndexes , carLicenseNumber , chassisNumber ,  contact , contactWay, giftCode, giftName, validDate, guidePrice, sellingPrice, amount, amountMoney, insuranceBillId , cdrq, insuranceWriter , remark);
                        }else if(giftType == 4){//储值卡类 storedCardData
                            overviewInsertd(storedCardData , ++storedCardIndexes , carLicenseNumber , chassisNumber ,  contact , contactWay, giftCode, giftName, validDate, guidePrice, sellingPrice, amount, amountMoney, insuranceBillId , cdrq, insuranceWriter , remark);
                        }else if(giftType == 5){//会员积分类 membershipIntegralData
                            overviewInsertd(membershipIntegralData , ++membershipIndexes , carLicenseNumber , chassisNumber ,  contact , contactWay, giftCode, giftName, validDate, guidePrice, sellingPrice, amount, amountMoney, insuranceBillId , cdrq, insuranceWriter , remark);
                        }
            ...
            overviewData.push([
                ...
                {"v": serviceTotalPrice, "s": {border: {top: {style: "thin"}, bottom: {style: "thin"}, left: {style: "thin"}, right:{style: "thin"}},font: {name: "宋体", sz: 10 }, alignment: {horizontal: "center", vertical: "center" , wrapText: "true"}}},
                {"v": boutiqueTotalPrice, "s": {border: {top: {style: "thin"}, bottom: {style: "thin"}, left: {style: "thin"}, right:{style: "thin"}},font: {name: "宋体", sz: 10 }, alignment: {horizontal: "center", vertical: "center" , wrapText: "true"}}},
                {"v": packagesTotalPrice, "s": {border: {top: {style: "thin"}, bottom: {style: "thin"}, left: {style: "thin"}, right:{style: "thin"}},font: {name: "宋体", sz: 10 }, alignment: {horizontal: "center", vertical: "center" , wrapText: "true"}}},
                {"v": storedCardTotalPrice, "s": {border: {top: {style: "thin"}, bottom: {style: "thin"}, left: {style: "thin"}, right:{style: "thin"}},font: {name: "宋体", sz: 10 }, alignment: {horizontal: "center", vertical: "center", wrapText: "true"}}},
                {"v": membershipIntegralTotalPrice, "s": {border: {top: {style: "thin"}, bottom: {style: "thin"}, left: {style: "thin"}, right:{style: "thin"}},font: {name: "宋体", sz: 10 }, alignment: {horizontal: "center", vertical: "center", wrapText: "true"}}},
                {"v": total, "s": {border: {top: {style: "thin"}, bottom: {style: "thin"}, left: {style: "thin"}, right:{style: "thin"}},font: {name: "宋体", sz: 10 }, alignment: {horizontal: "center", vertical: "center", wrapText: "true"}}}
            ])
        ...
        function overviewInsertd(sheetData , mapIndex, carLicenseNumber , chassisNumber ,  contact, contactWay, giftCode, giftType , validDate , guidePrice , sellingPrice
