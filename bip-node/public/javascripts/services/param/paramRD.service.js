...
angular.module('myApp')
    .service('paramRDService', ['$http','$q', function($http,$q){
        ...
        //查询所有失销/回退原因
        this.findAllReason = function(Data){
            var deferred = $q.defer();
            $http.post('/reason/findAllReason',{params:JSON.stringify(Data)})
                .success(function(result){
                    deferred.resolve(result);
                })
                .error(function(result){
        ...
        this.addReason = function(Data){
            var deferred = $q.defer();
            $http.post('/reason/addReason',{params:JSON.stringify(Data)})
                .success(function(result){
                    deferred.resolve(result);
                })
                .error(function(result){
        ...
        //修改回退失销原因
        this.updateReason = function(Data){
            var deferred = $q.defer();
            $http.post('/reason/updateReason',{params:JSON.stringify(Data)})
                .success(function(result){
                    deferred.resolve(result);
                })
                .error(function(result){
        ...
        //删除回退失销原因
        this.deleteById = function(Data){
            var deferred = $q.defer();
            $http.post('/reason/deleteById',{params:JSON.stringify(Data)})
                .success(function(result){
                    deferred.resolve(result);
                })
                .error(function(result){
