...
angular.module('myApp')
    .service('customerSAService', ['$http','$q', function($http,$q){
        ...
        this.traceReturn = function(customerId,htyy,principalId,principal){
            var deferred = $q.defer();
            $http.post('/customer/returnByFwgw',{customerId:customerId,htyy:htyy,principalId:principalId,principal:principal})
                .success(function(result){
                    deferred.resolve(result);
                })
                .error(function(result){
        ...
        //服务顾问的售后统计查询
        this.findSAServiceStatistics = function(startDate,endDate,showAll){
            var deferred = $q.defer();
            $http.post('/statistic/findSAServiceStatistics',{startDate:startDate,endDate:endDate,showAll:showAll})
                .success(function(result){
                    deferred.resolve(result);
                })
                .error(function(result){
        ...
        this.addTraceRecord = function(customerTraceRecode,traceFlag,htyy,htyyxz){
            var deferred = $q.defer();
            console.log(customerTraceRecode)
