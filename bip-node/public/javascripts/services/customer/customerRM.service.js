...
angular.module('myApp')
    .service('customerRMService', ['$http','$q', function($http,$q){

        //根据跟踪状态查询
        this.findByTraceStatu = function(condition){
            var deferred = $q.defer();
            $http.post('/customer/findByStatusQtzg',{condition:JSON.stringify(condition)})
        ...
        this.findByCondition = function(searchDatas){
            var deferred = $q.defer();
            $http.post('/customer/findByConditionQtzg',{searchDatas:JSON.stringify(searchDatas)})
        ...
        //审批
        this.approval = function(customerId,userId){
            var deferred = $q.defer();
            $http.get('/customer/updateAcceptStatu?customerId='+customerId+'&userId='+userId)
                .success(function(result){
                    deferred.resolve(result);
                })
                .error(function(result){
        ...
        this.traceReturn = function(customerId,clerkId,tyhtyj,principalId,principal){
            var deferred = $q.defer();
            $http.post('/customer/returnByFwgwM',{customerId:customerId,clerkId:clerkId,tyhtyj:tyhtyj,
        ...
        //销售经理更新负责人
        this.replacePrincipalSeM = function(clerkId,clerk,customerId,principalId,principal,ghfzryy){
            var deferred = $q.defer();
        ...
        this.unAgreeReturnBySeM = function(customerId,clerkId,principalId,principal,jjhtyy){
            var deferred = $q.defer();
            $http.post('/customer/unAgreeReturnByFwgwM',{customerId:customerId,clerkId:clerkId,principalId:principalId,principal:principal,jjhtyy:jjhtyy})
                // $http.get('pcList.json')
                .success(function(result){
                    deferred.resolve(result);
                })
