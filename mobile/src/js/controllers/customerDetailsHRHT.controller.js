angular.module('starter')
  .controller('CustomerDetailsHRHTController',
    ['$scope','$state','$timeout','$ionicPopup','$filter','pubHelper','$ionicModal','pubPopup','$ionicLoading','$ionicHistory','$ionicNavBarDelegate','$localStorage','$ionicViewSwitcher','$stateParams','customerDetailsService',
      function($scope,$state,$timeout,$ionicPopup,$filter,pubHelper,$ionicModal,pubPopup,$ionicLoading,$ionicHistory,$ionicNavBarDelegate,$localStorage,$ionicViewSwitcher,$stateParams,customerDetailsService) {
        var ctrl = this;
       ...
       //续保主管主动回退
        ...
        function addNewTrace(traceFlag) {
          ...
          var newTraceDatas = {
            customerId:customerId,lxr:lxr,lxfs:lxfs, cx:cx,quotedPrice:quotedPrice,
        ...
        function updateAcceptStatus(){
          ...
          if(!ctrl.principalId || !ctrl.principal){
            ctrl.principalId = parseInt(ctrl.userId),
              ctrl.principal = ctrl.userName
          }
